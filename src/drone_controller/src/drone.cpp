...
Drone::Drone(const std::string &model, int id, Point pos)
  : Node(
        model + "_" + std::to_string(id), 
    ...
    currentPosition(pos) 
{
    ...
    set_parameter(rclcpp::Parameter("use_sim_time", true)); //TODO I dont know how fix this
